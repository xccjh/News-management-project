...
CREATE TABLE `t_comment`  (
  ...
  `userIP` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
INSERT INTO `t_comment` VALUES (19, 8, '', '0:0:0:0:0:0:0:1', '2018-07-01 09:38:34');
INSERT INTO `t_comment` VALUES (20, 8, 'a', '0:0:0:0:0:0:0:1', '2018-07-01 09:38:38');
...
CREATE TABLE `t_link`  (
  ...
  `linkName` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `linkUrl` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `linkEmail` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `t_news`  (
  ...
  `isHead` tinyint(4) NULL DEFAULT NULL,
  `isImage` tinyint(4) NULL DEFAULT NULL,
  `imageName` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `isHot` tinyint(4) NULL DEFAULT NULL,
  PRIMARY KEY (`newsId`) USING BTREE,
  INDEX `typeId`(`typeId`) USING BTREE,
  CONSTRAINT `t_news_ibfk_1` FOREIGN KEY (`typeId`) REFERENCES `t_newstype` (`newsTypeId`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_news
-- ----------------------------
INSERT INTO `t_news` VALUES (1, '今天真高兴啊', '打击感的感觉是你当啊离开电脑发空间你g', '2017-04-10 13:14:09', '爸爸', 1, 33, 0, 1, '70jiyi.jpg', 0);
